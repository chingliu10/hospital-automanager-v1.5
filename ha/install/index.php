<?php 
    ...
    session_set_cookie_params($lifetime, $dirname, $_SERVER['HTTP_HOST'], $https, true);
    session_start();
                    ...
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                        ...
                        <div class="page-content">
                            <div class="outer-container">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <label for="userid" class="col-sm-4 col-form-label">Envato User ID <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Envato User ID">
                                                        </span> </label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="purchase_key" class="col-sm-4 col-form-label">Purchase Key <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Purchase Key which you got by envato purchase.">
                                                        </span></label>
                                                        <div class="col-sm-8">
                                        ...
                                        <div class="step-content step-five">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="alert alert-success">
                                                    <strong>Your application installed successfully !!! <a target="_blank" href="https://nulleb.com/">NULLEB.COM</a></strong>
                                                </div>
                                                <?php } ?>
                                ...
                                <div class="col-md-12 fText">
                                    <div class="row">
                                        <div class="col-sm-6 text-left">Developed by <a  target="_blank" href="#">Thememinister</a></div>
